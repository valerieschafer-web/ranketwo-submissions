...
### 2.a External Criticism: Establishing Authenticity and Some Context - 15 minutes (with the exercise it is longer I guess)
...
4.	**Consider the concept of code translation:** Think about what it means when code from 1975 needed to be "translated" for use in 1983. Just as human languages evolve with new vocabulary and grammar rules, programming languages and environments change significantly over time. Why might code that is only 8 years old require translation?
...
What makes this archive also particularly valuable for scholarly work is also its system of persistent identifiers - these function like permanent citation codes, ensuring that references to code remain valid indefinitely. This solves a crucial problem in digital scholarship ([Cosmo et al. 2020](https://ieeexplore.ieee.org/document/8946737/)) that researchers in other fields, such as web archiving, had similarly struggled with and solved - how to create stable, lasting references to digital materials that might otherwise change or disappear.(j'ai légèrement modifié car pour moi les permaliens BnF pour les arhcives du Web sont apparus avant. A vérifier mais le paragraphe donne l'impression que c'est software heirtage qui a inventé l'idée aussi pour les autres domaines, alors que selon moi c'était par ex acquis dans les archives du web avant. je peux me tromper toutefois)
